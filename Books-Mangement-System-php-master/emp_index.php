    ...
    <div class="container-fluid">
        ...
        <div>
            <ul class="nav navbar-nav">
                ...
                <li><a href="admin_borrow_info.php">借还情况</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <?php /*echo $result['userid'];  */?><img src="300046-106.jpg"width="30"height="30" >
                        <b class="caret"></b>
                    </a>
                    <ul class="dropdown-menu">
...
<h3 style="text-align: center">编号<?php echo $userid;  ?>号图书员工，您好，欢迎登陆本系统</h3><br/><br/><br/>
...
<h4 style="text-align: center">
    ...
    echo "共拥有读者{$resulta['b']}个。";

    ?>
</h4>

<div id="bot" style="text-align: center;font-size:40px;position:absolute;left:32%;bottom:30px "><i style="text-align: center">在   图   书   馆   上   班，是   一   种   心   灵   的   旅   行</i></div>
