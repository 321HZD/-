            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <?php echo $result['name'];  ?><img src="300046-106.jpg"width="30"height="30" >
                        <b class="caret"></b>
                    </a>
...
<div id="gonggao">
    ...
    <a href="https://www.douban.com/doulist/44353741/" style="font-style: italic;color: white">书单推荐：第十一届文津图书奖获奖图书</a><br>
